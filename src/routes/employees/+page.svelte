...
<div class="w-full">
    ...
    <div class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border rounded-lg p-2 px-6">
        ...
        <div class="mt-4 flex md:justify-between flex-col p-6">
            <div class="md:text-start text-center md:mb-0 mb-4">
                <span>Page {pageNumber + 1} of {$getEmployees?.data?.employees.totalPages}</span>
            </div>
            <div class="flex md:justify-end justify-center gap-x-6">
